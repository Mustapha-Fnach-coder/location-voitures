...
import MesReservation from "./Pages/Client/MesReservation";
import Layout from "./Pages/Client/Layout";
import AddVehicleForm from "./Pages/admin/AddVehicleForm";
...
function App() {
  return (
    <Router>
      <Routes>
        <Route path="/home" element={<RoleBasedRoute type="user"><Layout><HomeClient /></Layout></RoleBasedRoute>} />
        <Route path="/ContactUs" element={<Layout><ContactUs /></Layout>} />
        <Route path="/WhyUs" element={<Layout><WhyUs /></Layout>} />
        <Route path="/Voitures" element={<Layout><Voitures /></Layout>} />
        <Route path="/MesReservation" element={<RoleBasedRoute type="user"><Layout><FormReservation /><MesReservation /></Layout></RoleBasedRoute>} />
        <Route path="/car/:id" element={<Layout><CarDetails /></Layout>} />
        <Route path="/Signin" element={<Layout><Signin /></Layout>} />
        <Route path="/Signup" element={<Layout><Signup /></Layout>} />
        <Route path="/dashboard" element={<AddVehicleForm/>} />
        <Route path="/liste" element={<VehicleList/>} />
      </Routes>
    </Router>
  );
}
